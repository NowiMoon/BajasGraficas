...
<div class="d-flex my-0 py-0">
    ...
    <div class="d-flex flex-column bg-secondary bg-opacity-10 vh-100 align-items-center justify-content-evenly" style="width: 80px; z-index: 1000;">
        ...
        <a class="d-block icon-item text-center" style="text-decoration: none; color: black;"><img src="{{ asset('images/users_icon.svg') }}" alt="Usuarios">Gestion de Usuarios</a>
            ...
            <div class="card-footer text-end">
                ...
                <div class="card-footer text-end">
                    <div class="d-flex justify-content-center p-3">
                        ...
                        <button class="btn btn-success ms-3" id="generarGraficaBtn" disabled>Generar Gráfica</button>
                    </div>
                </div>
            </div>
        </div>
